...
public class Ex51ScoreAnswer extends JFrame implements ActionListener {
	private JTextField txt1, txt2, txt3, txt4;	// txt1 = 이름, txt2 ... = 국어, 영어, 수학 
	...
	public Ex51ScoreAnswer() {
		...
		addWindowListener(new WindowAdapter() {
			...
			public void windowClosing(WindowEvent e) {
				int result = JOptionPane.showConfirmDialog(Ex51ScoreAnswer.this, "정말 종료?", "종료 확인", JOptionPane.YES_NO_OPTION);
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == btnCalc) {
			...
			try {
				num3 = Integer.parseInt(txt4.getText());
			...
			switch (selImage) {
			case 1:
				lblphto.setIcon(new ImageIcon("D:\\\\\\\\Study\\\\\\\\Academy\\\\\\\\Acorn\\\\\\\\jsource\\\\\\\\jproject1\\\\\\\\src\\\\\\\\pack7gui\\\\\\\\pack1.jpg"));
				break;
