...
import pack3.MyFrame3;

public class Ex37Thread1 extends Thread{	// java.lang은 import가 생략된다.
	public Ex37Thread1() {
		
	}
	
	public Ex37Thread1(String name) {
		super(name); // name 받아서 super의 name에게 줌
	}
	
	public void run() {		// 자바는 메소드 이름이 이렇게 정해져있다.
		for(int i = 0; i <= 50; i++) {
			//System.out.print(i + " ");
	...
	public static void main(String[] args) {
		...
		try {
			...
			*/
			...
			th1.start(); 	// start가 run을 실행하는 역할이다.
			//Ex37Thread1 th2 = new Ex37Thread1();
			...
			th2.setPriority(MAX_PRIORITY);	// 스레드 스케줄러에게 우선 순위 요청
