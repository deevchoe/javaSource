...
public class Ex6Main {
	...
	public static void main(String[] args) {
		...
		System.out.println("kildong 주소 : " + kildong + " " + kildong.hashCode());	// hashcode는 10진수로 출력 기본은 16진수로 출력
		System.out.println("dajeong 주소 : " + dajeong + " " + dajeong.hashCode());
		
		Ex6Bank tom = null;		// Ex6Bank tom;
		System.out.println("tom 주소 : " + tom);
		//System.out.println("tom 예금액 : " + tom.getMoney());		// error : NullPointerException
		tom = dajeong;	// 주소 치환
