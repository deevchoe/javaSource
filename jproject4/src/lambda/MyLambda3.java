...
public class MyLambda3 {
	...
	private void test1() {
		List<String> list = Arrays.asList("Apple","Banana","Cherry");	// array 배열을 리스트 타입으로 바꿈
		...
		// Consumer : 반환값이 없으며, 1개의 매개변수를 받아들이고 반환값이 없는 accept()를 정의
	...
	private void test3() {
		...
		File dir = new File("d:/Study/Academy/Acorn");
